(function ($) {
	...
	$('.gallery-items').magnificPopup({
		...
		image: {
			...
			titleSrc: function (item) {
				return `
	    <h3 class="mfp-title">${item.el.attr('data-title')}</h3>
	    <p class="mfp-desc">${item.el.attr('data-desc')}</p>
	  `;
			}
		},
		gallery: {
	...
	/* Zoom Gallery screenshot */
	$('.gallery-itemstwo').magnificPopup({
		delegate: 'a',
		type: 'image',
		closeOnContentClick: false,
		closeBtnInside: false,
